					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								<select class="select_search" id="select_category"> <option>All Categories</option>
						...
						<div class="col-lg-3">
							<div class="all-category">
								...
								<ul class="main-category">
									...
									@foreach ($store_data['main_categories']->take(9) as $main_category) 
							    	
										<li><a href="{{route('shop.shop_by_categories', ['cat_id'=>$main_category->id, 'slug'=>$main_category->cat_name_hard(), 'cate'=>'main'])}}">{{$main_category->cat_name}}<i class="fa fa-angle-right" aria-hidden="true"></i></a>
											{{-- @php  dd($main_category->children)  @endphp --}}
