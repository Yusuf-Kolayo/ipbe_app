...
@section('content')
    ...
    @include('shop.header2') 
								...
								<!-- Shop By Price -->
									<div class="single-widget range">
										...
										<ul class="check-box-list">
											@if ($price_array)
											<li>
												<label class="checkbox-inline" for="1"><input name="price_range_1" checked id="1" type="checkbox">{!!naira()!!}{{$price_array[0]}} - {!!naira()!!}{{$price_array[1]}}</label>
											</li>
											<li>
												<label class="checkbox-inline" for="2"><input name="price_range_2" checked id="2" type="checkbox">{!!naira()!!}{{$price_array[1]}} - {!!naira()!!}{{$price_array[2]}}</label>
											</li>
											<li>
												<label class="checkbox-inline" for="3"><input name="price_range_3" checked id="3" type="checkbox">{!!naira()!!}{{$price_array[2]}} - {!!naira()!!}{{$price_array[3]}}</label>
											</li>
											<li>
												<label class="checkbox-inline" for="4"><input name="price_range_4" checked id="4" type="checkbox">{!!naira()!!}{{$price_array[3]}} - {!!naira()!!}{{$price_array[4]}}</label>
											</li>
											@else
											<li>
								...
								<div class="shop-top">
									<div class="shop-shorter">
										<div class="single-shorter">
                                          <h6 class="mb-0">{{$category->cat_name}}</h6>
										</div>
										{{-- <div class="single-shorter">
											<label>Show :</label>
											<select>
		...
		@section('footers')
           <script>
            ...
            $('#select_ordering').change(function(){ //   console.log($(this).val());
		        ...
		        var data2send={'ordering':ordering};  
		...
		//    $('.rabeya-checkbox').click(function(){
		// 		var price=[];
		// 		$("input").each(function() {
		// 			if ($(this).is(':checked')) {
