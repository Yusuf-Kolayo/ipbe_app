				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="{{ asset('storage/uploads/assets/'.$business_info->logo) }}" alt="#"></a>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<!-- End Single Widget -->
							<ul>
								<li><a href="{{$business_info->facebook}}"><i class="ti-facebook"></i></a></li>
								<li><a href="{{$business_info->twitter}}"><i class="ti-twitter"></i></a></li>
								{{-- <li><a href="#"><i class="ti-flickr"></i></a></li> --}}
								<li><a href="{{$business_info->instagram}}"><i class="ti-instagram"></i></a></li> 
							</ul>
						</div>
						<!-- End Single Widget -->
					</div>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a href="#" target="_blank">{{$business_info->name}}</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
