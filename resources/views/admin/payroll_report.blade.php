...
<div class="container-fluid card">
    <div class="row mb-2">
        <div class="col-12 alert alert-secondary">
            <h3><i class="fas fa-th-list mr-2"></i>Payroll Summary</h3>
        </div>
    </div>
    <div class="row mb-2">
        <div class="col-md-9">
        ...
        <div class="col-md-3">
            <div id="curve_chart" class="img-fluid"></div>
        </div>
    </div>
    <div class="row my-1 text-center">
        <div class="col-12 ">
            <button class="font-weight-bolder btn btn-outline-primary">+</button>
        </div>
    </div>
</div>
