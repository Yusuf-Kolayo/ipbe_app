...
class BaseController extends Controller
{
    ...
    public $app_sections = array ( 
        ...
        ['brand',       [['index','view brands'],['store','save new brand'],['update','edit brand'],['destroy','delete brand']]]
    );
