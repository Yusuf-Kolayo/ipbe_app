...
var months= [];   var m_amts= [];
readTextFile("get_json_data.php?tp=sales_revenue", function(text) {
var data = JSON.parse(text);

data.forEach(function(entry) {
months.push(entry[0]);   m_amts.push(entry[1]);  
});
...
//usage:
var days= [];  var amts= [];
readTextFile("get_json_data.php?tp=sales_overview", function(text) {
var data = JSON.parse(text);

data.forEach(function(entry) {
days.push(entry[0]);   amts.push(entry[1]);  
});
...
//  console.log(days);  console.log(amts);
